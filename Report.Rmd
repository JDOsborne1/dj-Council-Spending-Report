...
extract <- links %>% 
        dplyr::filter(link != "http://www.southglos.gov.uk//documents/2-May-2018-Invoices-ALL-Paid-over-£500-for-web-publish.csv") %>% 
        tail(40) %>% 

...
URL <- "http://hosted.southglos.gov.uk/councilpayments/november10.csv"
test2 <- "https://www.southglos.gov.uk//documents/Sep-2019-Payments-Over-500.csv" %>% customDataReader()
